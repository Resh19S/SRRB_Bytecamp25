...
const stateGuidelines = [
  {
    ...
    state: "Mumbai",
    essentialRules: [
      "Avoid traveling during peak hours to escape heavy traffic",
      "Respect local customs and dress appropriately",
      "Be cautious when crossing roads due to high traffic",
    ],
    optionalRules: [
      "Consider using Mumbai local trains for quicker travel",
      "Learn basic Marathi or Hindi phrases",
      "Keep small change handy for local vendors and transport",
    ],
    permits: [
      "No special permits required for general areas",
      "Special permits needed for filming in public places",
    ],
    safetyTips: [
      "Stay alert in crowded areas to avoid pickpocketing",
      "Use official taxis or ride-sharing apps",
      "Keep emergency contacts and police helpline numbers accessible",
    ],
  },
